...
function deleteExpense(li){
    ...
    axios.post('http://localhost:' + PORT + '/expense/delete-expense/' + expenseId)
    .then((res) => {
...
function showAllExpensesInDOM(){
    axios.get('http://localhost:' + PORT + '/expense/get-expenses')
    .then((res) => {
...
function addExpense(e){
    ...
    axios.post('http://localhost:' + PORT + '/expense/add-expense', expense)
    .then((res) => {
